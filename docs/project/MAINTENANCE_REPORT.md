...
| cli | 0.2.2 | 2 | 2 | 2026-08-07T23:59:00+08:00 | 通过 | `b73f86eca23e` |
| gui | 0.7.4 | 4 | 4 | 2026-08-07T20:27:28.3613467+08:00 | 通过 | `55a03d59f816` |
| materials | 0.12.7 | 4 | 4 | 2026-08-07T23:59:00+08:00 | 通过 | `137c0973fa69` |
...
| materials-control | 0.3.3 | 3 | 3 | 2026-08-07T23:50:00+08:00 | 通过 | `aba409da25c3` |
| materials-domain | 0.3.3 | 2 | 2 | 2026-08-07T23:50:00+08:00 | 通过 | `7b4527507db2` |
...
| materials-orchestration | 0.1.5 | 5 | 5 | 2026-08-07T23:59:00+08:00 | 通过 | `9af5b078292e` |
...
范围：Intent Scheduler P1 ???CLI ?????Windows ?????? PR ????

执行内容：

- ?? CLI ????????? Intent CLI ???????????
- ?? Intent ??????? ControlStore ? IntentFilter ??
- ???? Node ??????????? Windows ????????????
- ? origin/main ?????????????????????
...
- ????CLI ???????? logFn
- ????CLI ??????????????
- ????coding claim ??? Windows ?????? WSL ??? EBUSY ????
- ???????????? PR ??????

验证：

- [x] 130/130 main tests passed
- [x] Intent CLI integration scenarios passed
- [x] Component documentation check passed (25 components, 5 affected)
- [x] npm run verify

下次检查触发条件：?? Intent ????CLI ?????ExecutionEnv Shell ??????????
